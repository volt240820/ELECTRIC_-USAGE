...
import { Calendar, Zap, FileImage, Building2, Tag, ChevronDown, CheckCircle2, FileText } from 'lucide-react';
  ...
  return (
    <div className="w-full bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden animate-fade-in mb-8 last:mb-0">
        <div className="flex flex-col lg:flex-row items-stretch h-full">
            ...
            {/* LEFT: Image Panel */}
            <div className="w-full lg:w-5/12 bg-slate-900 relative min-h-[400px] lg:min-h-0 p-4 flex flex-col justify-center items-center group">
                <div className="absolute top-0 left-0 w-full p-3 bg-gradient-to-b from-black/60 to-transparent flex justify-between items-start z-10">
                ...
                {imageUrl && (
                    <img 
                        src={imageUrl} 
                        alt="Meter Reading" 
                        className="max-w-full max-h-[600px] object-contain shadow-2xl transition-transform duration-300 group-hover:scale-[1.02]" 
                    />
                )}
            </div>
